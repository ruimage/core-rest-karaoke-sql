  ...
  return (
    <Layout>
      ...
      <main  className="form-wrapper" role="main">
        <form id="edit-entry-form" method="POST" action={`/entries/${entry.id}`} data-id={entry.id}>
          <label htmlFor="singer_name_input">Singer name:</label>
          <input id="singer_name_input" name="singer" type="text" value={entry.singer} />

          <label htmlFor="songTitle_input">Song title:</label>
          <input id="songTitle_input" name="songTitle" type="text" value={entry.songTitle} />
